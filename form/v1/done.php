...
$dbh = new PDO('mysql:host=localhost;dbname=TECHIS;charset=utf8', 'root', '');

$stmt = $dbh->prepare(
    "INSERT INTO MEMBER(NAME, KANA, TEL, MAIL, YEAR, SEX, MAGAGINE) VALUES(:NAME, :KANA, :TEL, :MAIL, :YEAR, :SEX, :MAGAGINE)"
);
